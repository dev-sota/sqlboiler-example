...
func (o *GooseDBVersion) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for goose_db_version")
	}
...
func (o *GooseDBVersion) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for goose_db_version")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for goose_db_version")
	}
